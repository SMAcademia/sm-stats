...
SM.sidebar = (function () {
  const ICONS = {
    ...
    planificacion: '<rect x="5" y="4" width="14" height="17" rx="2.2"/><path d="M9 4V3.3A1.3 1.3 0 0 1 10.3 2h3.4A1.3 1.3 0 0 1 15 3.3V4"/><path d="M8.5 12.5l2.2 2.2 4.3-4.4"/><path d="M8.5 17.5h5"/>',
    cuadrante: '<rect x="3" y="4.5" width="18" height="15" rx="2"/><path d="M3 9.5h18"/><path d="M9 9.5V19.5"/><path d="M15 9.5V19.5"/><path d="M3 14.5h18"/>',
  ...
  const ITEMS = [
    ...
    { key: 'planificacion', label: 'Planificación', href: 'planificacion.html' },
    { key: 'cuadrante', label: 'Cuadrante semanal', href: 'cuadrante.html' },
